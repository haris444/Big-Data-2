    ...
    def __getitem__(self, idx: int) -> tuple:
        ...
        if N_actual_pixels > self.S_num_sampled_pixels:
            if self.is_train:
                ...
                selected_indices = available_indices[:self.S_num_sampled_pixels]
        ...
        # From (Time, Channels, S_num_sampled_pixels) to (S_num_sampled_pixels, Time, Channels)
